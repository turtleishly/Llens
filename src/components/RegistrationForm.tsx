  ...
  const validateStep = async () => {
    ...
    switch (currentStep) {
      ...
      case 1:
        ...
        break;
      case 2:
        fieldsToValidate = ["member1FullName", "member1ContactNumber", "member1IcNumber", "member1Email", "member1School", "member1Qualification", "member1GraduationDate", "member2FullName", "member2ContactNumber", "member2IcNumber", "member2Email", "member2School", "member2Qualification", "member2GraduationDate", "member3FullName", "member3ContactNumber", "member3IcNumber", "member3Email", "member3School", "member3Qualification", "member3GraduationDate", "member4FullName", "member4ContactNumber", "member4IcNumber", "member4Email", "member4School", "member4Qualification", "member4GraduationDate"];
        break;
      case 3:
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              {currentStep === 0 ? <Button type="button" onClick={next} size="lg" className="gap-2">
                  ...
                  Continue
                  <ArrowRight className="w-4 h-4" />
                </Button> : <Button type="submit" disabled={isSubmitting} onClick={e => {
              e.preventDefault();
              form.handleSubmit(onSubmit)();
            }} className="gap-2">
